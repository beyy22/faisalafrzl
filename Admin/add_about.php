...
<div class="flex max-w-7xl mx-auto mt-8 px-4">
    ...
    <aside class="w-1/4 bg-white rounded shadow p-4">
        ...
        <ul class="space-y-2 text-gray-700">
            ...
            <li><a href="data_about.php" class="block font-semibold text-blue-800">About</a></li>
            <li>
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
        <form action="proses_add_about.php" method="post" class="space-y-6">
            <div>
                <label for="about" class="block text-sm font-medium text-gray-700 mb-1">Isi Tentang Saya</label>
                <textarea id="about" name="about" rows="6" required
                          class="w-full p-3 border rounded focus:outline-none focus:ring focus:border-blue-500"></textarea>
            </div>
